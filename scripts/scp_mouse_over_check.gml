...
tmp_return = 0;
if ( mouse_x > tmp_target.bbox_left - tmp_extra && mouse_x < tmp_target.bbox_right + tmp_extra )
{
    if ( mouse_y > tmp_target.bbox_top  - tmp_extra && mouse_y < tmp_target.bbox_bottom  + tmp_extra )
    {
        tmp_return = 1;
    }
}
